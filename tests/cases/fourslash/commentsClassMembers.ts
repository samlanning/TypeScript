...
verify.completions(
    ...
    {
        marker: "114",
        includes: { name: "a", text: "(property) cWithConstructorProperty.a: number", documentation: "more info about a\nthis is first parameter a" },
    },
    {
        marker: "115",
        includes: { name: "a", text: "(parameter) a: number", documentation: "more info about a\nthis is first parameter a" },
        isNewIdentifierLocation: true,
    },
);
